# Rewrites all the constants in the URI::REGEXP module, so domain names 
# with underscores are accepted.

# Only the DOMLABEL is actually changed (added underscore to the allowed
# list of characters in a domain component), but as all the other constants
# are calculated at definition time, they have to be redefined too

module URI

  TEST = "https://fbcdn_sphotos_h-a.akamaihd.net/hphotos-ak-snc7/s720x720/317086_10150384198894932_1527836606_n.jpg"
